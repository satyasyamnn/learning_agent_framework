...
// ── LLM client factory ────────────────────────────────────────────────────────
var azureOpenAI = new AzureOpenAIClient(endpoint, new System.ClientModel.ApiKeyCredential(apiKey));
...
var workflow = new WorkflowBuilder("SupplierOrchestratorFlow")
